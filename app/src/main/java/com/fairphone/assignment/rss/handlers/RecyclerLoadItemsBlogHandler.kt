...
import com.fairphone.assignment.rss.utils.RSSParser
...
class RecyclerLoadItemsBlogHandler(private val rssHomeViewModel: RssHomeViewModel,
     ...
     * TAG : class name
     */
    private val TAG = "RecyclerLoadItemsBlogHandler"
    ...
    private fun launchRequest(urlPath: String, view: RecyclerView) {
        ...
        runBlocking {
            ...
            GlobalScope.launch(handler) {
                ...
                val service = retrofitClientInstance.getServiceBlogArticles(Constants.FAIRPHONE_BASE_URL, view.context)
